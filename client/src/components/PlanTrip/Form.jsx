    ...
    <div className="w-full p-6 bg-white rounded-lg shadow-md flex flex-col md:flex-row justify-between">
      <form className="w-full md:w-4/6 mb-6 md:mb-0">
        ...
        <div className="text-center px-3">
          <button
            type="submit"
            className="px-4 py-2 bg-green-600 text-white rounded-md shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
            Submit
          </button>
        </div>
      </form>
